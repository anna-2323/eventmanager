...
if (!user.logged_in || user.role !== 0) {
  ...
  function toMonths(stats) {
    return stats.map((item) => {
      const month = Number(item.month.split("-")[1]);
